...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("bookZonePublicGw");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("bookZonePublicGw");
        ...
        config.getMapConfigs().put("az.crbn.bookzone.publicgw.domain.*", initializeDomainMapConfig(jHipsterProperties));
